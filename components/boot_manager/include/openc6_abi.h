...
// Integrity marker "C6BI" (C6 BIOS Interface) to validate the calling context
 ...
 */
typedef struct {
    uint32_t magic;    // Must evaluate to OPENC6_ABI_MAGIC
    uint32_t version;  // Must evaluate to OPENC6_ABI_VERSION
